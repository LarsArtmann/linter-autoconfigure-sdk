...
| T23 | Upload `assets/branding/social-preview.png` as the GitHub social preview (Settings → General → Social preview → Edit → Upload an image; no deep URL exists; no API)                                    | Low    | S      | flip report f30-32; asset verified 2026-09-11: 1280x640, 106KB (< 1MB GitHub limit)                             |
